...
def build_u_v_d(eta: ArrayLike, realsmall: float):
    ...
    d_eta = np.atleast_2d(np.diag(d_eta))  # match matlab output of svd
...
def gensys(
    ...
    .. math::
        ...
        Γ_0*y_t = Γ_1*y_{t-1} + c + Ψ*z_t + Π*η_t,
    ...
    .. math::
        ...
        y_t = G_1*y_{t-1} + C + \\text{impact} \\cdot z_t + ywt \\cdot (I - fmat \\cdot L^{-1})^{-1} \\cdot fwt \\cdot z_{t+1}.
